...
$orchestratorJob = Start-Job -ScriptBlock {
    Set-Location "c:\Users\BandiPreethamReddy\Desktop\Tagent\backend\services\orchestrator-service"
...
$frontendJob = Start-Job -ScriptBlock {
    Set-Location "c:\Users\BandiPreethamReddy\Desktop\Tagent\frontend"
